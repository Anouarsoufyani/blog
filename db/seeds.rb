...
5.times do
  category = Categorie.create(name: Faker::Color.color_name)
  2.times do
...
15.times do
  comment = Commentaire.create(content: Faker::OnePiece.quote, user_id: rand(User.first.id..User.last.id), article_id: rand(Article.first.id..Article.last.id))
end
